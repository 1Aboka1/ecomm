...
func (ec *executionContext) field_Mutation_addCartItem_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCartItemInput2ecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItemInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_deleteCartItem_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNDeleteCartItemInput2ecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐDeleteCartItemInput(ctx, tmp)
	}
...
func (ec *executionContext) _Cart_cart_items(ctx context.Context, field graphql.CollectedField, obj *model.Cart) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCartItem2ᚕᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItem(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_addCartItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCart2ᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCart(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNCart2ecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCart(ctx context.Context, sel ast.SelectionSet, v model.Cart) graphql.Marshaler {
	return ec._Cart(ctx, sel, &v)
}

func (ec *executionContext) marshalNCart2ᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCart(ctx context.Context, sel ast.SelectionSet, v *model.Cart) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNCartItem2ᚕᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItem(ctx context.Context, sel ast.SelectionSet, v []*model.CartItem) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOCartItem2ᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalNCartItemInput2ecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItemInput(ctx context.Context, v any) (model.CartItemInput, error) {
	res, err := ec.unmarshalInputCartItemInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNDeleteCartItemInput2ecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐDeleteCartItemInput(ctx context.Context, v any) (model.DeleteCartItemInput, error) {
...
func (ec *executionContext) marshalOCartItem2ᚖecommᚑbackendᚋgraphqlsᚋcartᚋgraphᚋmodelᚐCartItem(ctx context.Context, sel ast.SelectionSet, v *model.CartItem) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
